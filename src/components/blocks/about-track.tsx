    ...
    <section className="py-32 max-w-6xl mx-auto px-4 grid grid-cols-2 gap-8">
      ...
      <div>
        <h2 className="text-5xl font-bold font-title uppercase mb-4 text-neutral-900">
          42 km durch 3 <span className="bg-amber-300">Länder</span>
        </h2>
        <p className="text-lg mb-8">
          Der 3Länderlauf führt Sie durch die schönsten Städte Deutschlands, Frankreichs und der Schweiz.
        </p>
